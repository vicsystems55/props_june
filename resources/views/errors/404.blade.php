...
<!-- Mirrored from grandetest.com/theme/findhouse-html/page-error.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Oct 2020 13:16:30 GMT -->
<head>
<meta charset="utf-8">
					  	...
					  	<div class="row mt25 tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
					  		<div class="col-lg-6 col-xl-6">
					  			<div class="login_thumb">
					  				<img class="img-fluid w100" src="{{config('app.url')}}props_styles/images/resource/login.jpg" alt="login.jpg">
					  			</div>
					  		</div>
					  		<div class="col-lg-6 col-xl-6">
					  	...
					  	<div class="row mt25 tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
					  		<div class="col-lg-6 col-xl-6">
					  			<div class="regstr_thumb">
					  				<img class="img-fluid w100" src="{{config('app.url')}}props_styles/images/resource/regstr.jpg" alt="regstr.jpg">
					  			</div>
					  		</div>
					  		<div class="col-lg-6 col-xl-6">
			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
					<div class="footer_contact_widget">
						<h4>Contact Us</h4>
						<ul class="list-unstyled">
							<li><a href="#"><span class="__cf_email__" data-cfemail="b5dcdbd3daf5d3dcdbd1dddac0c6d09bd6dad8">[email&#160;protected]</span></a></li>
...
<!-- Wrapper End -->
<script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script type="text/javascript" src="{{config('app.url')}}props_styles/js/jquery-3.3.1.js"></script>
...
<!-- Mirrored from grandetest.com/theme/findhouse-html/page-error.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Oct 2020 13:16:31 GMT -->
</html>